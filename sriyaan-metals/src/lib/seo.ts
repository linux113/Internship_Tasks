...
export function buildMetadata({
  ...
  const fullTitle = title.includes("SRIYAAN METALS")
    ? title
...
export function organizationJsonLd(settings: Record<string, string>) {
  return {
    ...
    "@type": "Organization",
    name: settings.companyName || "SRIYAAN METALS",
    url: siteUrl("/"),
    logo: siteUrl("/sriyaan-logo.jpeg"),
...
export function productJsonLd(product: {
  ...
  return {
    ...
    brand: { "@type": "Brand", name: "SRIYAAN METALS" },
...
export function articleJsonLd(post: {
  ...
  return {
    ...
    publisher: {
      "@type": "Organization",
      name: "SRIYAAN METALS",
      logo: { "@type": "ImageObject", url: siteUrl("/sriyaan-logo.jpeg") },
    },
