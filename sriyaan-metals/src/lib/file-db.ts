...
// The development adapter intentionally accepts Prisma-shaped dynamic records.
...
const RELATIONS: Record<string, Record<string, { table: string; type: "one" | "many"; fk: string; local?: string }>> = {
  products: {
    ...
    specifications: { table: "productSpecifications", type: "many", fk: "productId" },
  },
  categories: {
...
function hydrateDates(value: any): any {
...
export const prisma = {
  ...
  productSpecification: createModel("productSpecifications"),
