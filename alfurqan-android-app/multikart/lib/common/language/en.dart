...
final dynamic en = {
  ...
  "shipped": "Shipped",
  "delivered": "Delivered",
  "exclusiveOfAllTaxes": "exclusive of all taxes",
  "pending": "Pending",
  ...
  "confirmReturnOrder": "Request a return for this order as per the return policy?",
  "orderCancelled": "Order cancelled",
  "cancelRequestSent": "Cancellation request sent to the shop",
  "returnRequested": "Return request sent to the shop",
  "returnNotAvailable": "Return is not available for this order",
  ...
  "couponMinOrderMsg": "Minimum order for this coupon is",
  "firstOrderOnly": "Valid on first order only",
  "firstOrderCouponMsg": "This coupon is valid only on your first order",
  "validTill": "Valid till",
  "profilePhotoUpdated": "Profile photo updated",
  "photoPickFailed": "Could not pick photo. Please try again",
  "couponApplied": "Coupon applied!",
  "couponInvalid": "Coupon didn't apply (invalid, expired or minimum order amount not met)",
  "couponsLoadFailed": "Could not load coupons - pull down to try again",
  "noCouponsAvailable": "No coupons available right now",
  "notificationsLoadFailed": "Could not load notifications - please try again later",
