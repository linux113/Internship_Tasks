    ...
    >
      <div className="container-wide flex items-center justify-between gap-6 h-[78px]">
        <Link href="/" className="flex items-center gap-3 shrink-0">
          <span className="grid h-10 w-10 place-items-center border border-brass text-brass font-display tracking-[0.14em] text-lg">
            H
          </span>
          <span className="leading-none">
            <span className="block font-display tracking-[0.28em] text-[1.05rem]">
              HELVIX
            </span>
            <span className="block text-[0.62rem] tracking-[0.32em] text-mist uppercase mt-1">
              Industrial
            </span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          <a
            href={whatsappLink(
              whatsapp,
              "Hello Helvix, I would like to discuss a fastener requirement.",
            )}
            target="_blank"
