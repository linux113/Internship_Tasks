    ...
    <footer className="bg-ink text-paper border-t border-white/8">
      <div className="container-site py-16 grid gap-12 md:grid-cols-2 lg:grid-cols-5">
        <div className="lg:col-span-2">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center border border-brass text-brass font-display">
              H
            </span>
            <span className="font-display tracking-[0.28em] text-xl">HELVIX</span>
          </div>
          <p className="mt-5 max-w-sm text-mist leading-relaxed">
            Precision industrial fasteners engineered, inspected and shipped
            from Sanand to projects and OEMs worldwide.
          </p>
      ...
      <div className="border-t border-white/8">
        <div className="container-site py-5 flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between text-xs text-mist tracking-wide">
          <p>© {new Date().getFullYear()} {s.legalName || "Helvix Industrial Fasteners Pvt. Ltd."}</p>
