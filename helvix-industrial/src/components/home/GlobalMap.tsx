  ...
  return (
    <section className="relative bg-ink py-24 overflow-hidden">
      ...
      <div className="container-site relative">
        <Reveal>
          <p className="eyebrow">Export footprint</p>
          ...
          <p className="mt-6 max-w-2xl text-haze text-lg">
            Supplying industrial customers across international markets with
            reliable products, professional service and export support.
          </p>
        </Reveal>
