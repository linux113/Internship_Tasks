...
export const metadata = buildMetadata({
  ...
  description: "How Helvix Industrial handles enquiry and website data.",
  path: "/privacy",
});
    ...
    <>
      ...
      <section className="surface-paper text-ink py-20">
        <div className="container-site max-w-3xl space-y-4 leading-relaxed text-[#3d434c]">
          <p>
            Helvix Industrial collects only the information you submit through enquiry, quote and
          ...
          <p>
            We do not sell personal data. Access is limited to authorised Helvix staff. Files you
