...
export const metadata = buildMetadata({
  ...
  description:
    "Browse Helvix industrial fasteners: bolts, nuts, washers, screws, studs, rods, anchors and specials.",
  path: "/products",
});
  ...
  return (
    <>
      <PageHero
        eyebrow="Catalogue"
        title="Product Catalogue"
        subtitle="Search thousands of industrial fasteners by standard, grade, size and application."
      ...
      <section className="surface-paper text-ink py-16">
        <div className="container-site grid lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-9">
            ...
            {products.length === 0 && (
              <p className="text-[#5a616c]">No products match these filters.</p>
            )}
